 ...
 * {@link com.herocraft.mod.symbiote.entity.SymbioteEntity} placed. Shared by both structures.
 *
...
public final class SymbioteSpawnState extends SavedData {
	private static final String FILE_ID = HeroCraftMod.MOD_ID + "_symbiote_sites";
