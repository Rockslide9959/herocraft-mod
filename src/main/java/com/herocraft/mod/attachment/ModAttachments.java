...
public final class ModAttachments {
	/**
	 * Hidden worthiness score. See {@link com.herocraft.mod.worthiness.Worthiness}. {@code copyOnDeath()}
	...
	public static final AttachmentType<CooldownState> COOLDOWNS = AttachmentRegistry.create(
			HeroCraftMod.id("thor_cooldowns"),
	...
	public static final AttachmentType<Boolean> LASER_ACTIVE = AttachmentRegistry.create(
			HeroCraftMod.id("thor_laser_active"),
			builder -> builder.initializer(() -> false));
	...
	public static final AttachmentType<Integer> THOR_WRATH_CHARGE = AttachmentRegistry.create(
			HeroCraftMod.id("thor_wrath_charge"),
	...
	public static final AttachmentType<StormCallState> STORM_CALL_STATE = AttachmentRegistry.create(
			HeroCraftMod.id("thor_storm_call_state"),
			builder -> builder.initializer(StormCallState::new));

	/**
	 * Ticks remaining of "hammerless flight" grace -- see {@link com.herocraft.mod.power.ThorPowers}'s
	...
	public static final AttachmentType<Integer> HAMMERLESS_FLIGHT_TICKS = AttachmentRegistry.create(
			HeroCraftMod.id("thor_hammerless_flight_ticks"),
			builder -> builder.initializer(() -> 0)
					.syncWith(ByteBufCodecs.VAR_INT, AttachmentSyncPredicate.targetOnly()));

	/**
	 * The {@link com.herocraft.mod.item.ModDataComponents#HAMMER_ID} of the Mjolnir this player has
	 * bound, or absent. This -- not what is in their hands -- is the single source of truth for
	 * whether they have the Power of Thor (see {@link com.herocraft.mod.power.ThorPassives}) and for
	...
	public static final AttachmentType<UUID> BOUND_HAMMER_ID = AttachmentRegistry.create(
			HeroCraftMod.id("thor_bound_hammer"),
	...
	public static final AttachmentType<Long> LAST_HURT_TICK = AttachmentRegistry.create(
			HeroCraftMod.id("thor_last_hurt_tick"),
	...
	public static final AttachmentType<ExperimentalState> EXPERIMENTAL_STATE = AttachmentRegistry.create(
			HeroCraftMod.id("experimental_state"),
	...
	public static final AttachmentType<Boolean> IRON_MAN_FLYING = AttachmentRegistry.create(
			HeroCraftMod.id("iron_man_flying"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));

	/**
	 * "changes 22": whether the player is flying on a bare {@link com.herocraft.mod.ironman.item.RepulsorItem}
	...
	public static final AttachmentType<Boolean> REPULSOR_BOOTS_FLYING = AttachmentRegistry.create(
			HeroCraftMod.id("repulsor_boots_flying"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));
	...
	public static final AttachmentType<Boolean> IRON_MAN_FACEPLATE_OPEN = AttachmentRegistry.create(
			HeroCraftMod.id("iron_man_faceplate_open"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));
	...
	public static final AttachmentType<Boolean> IRON_MAN_BLADES = AttachmentRegistry.create(
			HeroCraftMod.id("iron_man_blades"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));
	...
	public static final AttachmentType<TonyStarkState> TONY_STARK_STATE = AttachmentRegistry.create(
			HeroCraftMod.id("tony_stark_state"),
	...
	public static final AttachmentType<GraveboundState> GRAVEBOUND_STATE = AttachmentRegistry.create(
			HeroCraftMod.id("gravebound_state"),
	 ...
	 */
	public static final AttachmentType<com.herocraft.mod.spider.data.SpiderManState> SPIDER_MAN_STATE =
			AttachmentRegistry.create(HeroCraftMod.id("spider_man_state"),
					builder -> builder.persistent(com.herocraft.mod.spider.data.SpiderManState.CODEC)
							.copyOnDeath()
							.initializer(com.herocraft.mod.spider.data.SpiderManState::new)
							.syncWith(ByteBufCodecs.fromCodec(com.herocraft.mod.spider.data.SpiderManState.CODEC),
	 ...
	 */
	public static final AttachmentType<com.herocraft.mod.spider.data.SpiderClimbLocal> SPIDER_CLIMB_LOCAL =
			AttachmentRegistry.create(HeroCraftMod.id("spider_climb_local"),
					builder -> builder.initializer(com.herocraft.mod.spider.data.SpiderClimbLocal::new));
	...
	public static final AttachmentType<Integer> SPIDER_BLOSSOM_CHARGE = AttachmentRegistry.create(
			HeroCraftMod.id("spider_blossom_charge"),
			builder -> builder.initializer(() -> 0)
					.syncWith(ByteBufCodecs.VAR_INT, AttachmentSyncPredicate.targetOnly()));
	 ...
	 */
	public static final AttachmentType<com.herocraft.mod.maxsteel.data.MaxSteelState> MAX_STEEL_STATE =
			AttachmentRegistry.create(HeroCraftMod.id("max_steel_state"),
					builder -> builder.persistent(com.herocraft.mod.maxsteel.data.MaxSteelState.CODEC)
							.copyOnDeath()
							.initializer(com.herocraft.mod.maxsteel.data.MaxSteelState::new)
							.syncWith(ByteBufCodecs.fromCodec(com.herocraft.mod.maxsteel.data.MaxSteelState.CODEC),
									AttachmentSyncPredicate.all()));
	...
	public static final AttachmentType<Boolean> MAX_STEEL_FLYING = AttachmentRegistry.create(
			HeroCraftMod.id("max_steel_flying"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));
	...
	public static final AttachmentType<Integer> MAX_STEEL_CANNON_CHARGE = AttachmentRegistry.create(
			HeroCraftMod.id("max_steel_cannon_charge"),
			builder -> builder.initializer(() -> 0)
					.syncWith(ByteBufCodecs.VAR_INT, AttachmentSyncPredicate.targetOnly()));
	...
	public static final AttachmentType<Boolean> MAX_STEEL_FACEPLATE_OPEN = AttachmentRegistry.create(
			HeroCraftMod.id("max_steel_faceplate_open"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));
	...
	public static final AttachmentType<Boolean> SPIDER_MAN_MASK_OPEN = AttachmentRegistry.create(
			HeroCraftMod.id("spider_man_mask_open"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));
	 ...
	 */
	public static final AttachmentType<com.herocraft.mod.punisher.data.PunisherState> PUNISHER_STATE =
			AttachmentRegistry.create(HeroCraftMod.id("punisher_state"),
					builder -> builder.persistent(com.herocraft.mod.punisher.data.PunisherState.CODEC)
							.copyOnDeath()
							.initializer(com.herocraft.mod.punisher.data.PunisherState::new)
							.syncWith(ByteBufCodecs.fromCodec(com.herocraft.mod.punisher.data.PunisherState.CODEC),
									AttachmentSyncPredicate.all()));
	 ...
	 * dimension change / power loss by {@link com.herocraft.mod.symbiote.Symbiote} (there must be
	 ...
	 */
	public static final AttachmentType<com.herocraft.mod.symbiote.SymbioteState> SYMBIOTE_STATE =
			AttachmentRegistry.create(HeroCraftMod.id("symbiote_state"),
					builder -> builder.persistent(com.herocraft.mod.symbiote.SymbioteState.CODEC)
							.copyOnDeath()
							.initializer(com.herocraft.mod.symbiote.SymbioteState::new)
							.syncWith(ByteBufCodecs.fromCodec(com.herocraft.mod.symbiote.SymbioteState.CODEC),
									AttachmentSyncPredicate.all()));
	...
	public static final AttachmentType<Boolean> FIREARM_AIMING = AttachmentRegistry.create(
			HeroCraftMod.id("firearm_aiming"),
			builder -> builder.initializer(() -> false)
					.syncWith(ByteBufCodecs.BOOL, AttachmentSyncPredicate.all()));
	...
	public static void initialize() {
		...
		// this method exists so HeroCraftMod has an explicit, readable init call.
	}
}
