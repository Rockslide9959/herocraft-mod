 ...
 * {@code data/herocraft/worldgen/structure/mjolnir_crater.json} and
 * {@code data/herocraft/worldgen/structure_set/mjolnir_crater.json} -- ordinary datapack JSON, the
...
public class MjolnirCraterStructure extends Structure {
	public static final ResourceKey<Structure> KEY =
			ResourceKey.create(Registries.STRUCTURE, HeroCraftMod.id("mjolnir_crater"));
