 ...
 * {@code structure_set}, {@code /locate structure herocraft:graveyard} works for free.
 */
public class GraveyardStructure extends Structure {
	public static final ResourceKey<StructureType<?>> TYPE_KEY =
			ResourceKey.create(Registries.STRUCTURE_TYPE, HeroCraftMod.id("graveyard"));
	...
	public static final ResourceKey<Structure> KEY =
			ResourceKey.create(Registries.STRUCTURE, HeroCraftMod.id("graveyard"));
