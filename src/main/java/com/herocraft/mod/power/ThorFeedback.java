...
public final class ThorFeedback {
	...
	public static void recallStartedNear(Player player) {
		actionBar(player, "message.herocraft.recall.returning", ChatFormatting.AQUA);
	...
	public static void recallStartedFar(Player player) {
		actionBar(player, "message.herocraft.recall.answering", ChatFormatting.AQUA);
		thunderCue(player, 0.8f);
	}

	public static void recallArrived(Player player) {
		actionBar(player, "message.herocraft.recall.returned", ChatFormatting.GOLD);
	}
	...
	public static void recallAlreadyHeld(Player player) {
		actionBar(player, "message.herocraft.recall.already_held", ChatFormatting.GRAY);
	}

	public static void recallNoHammer(Player player) {
		actionBar(player, "message.herocraft.recall.none", ChatFormatting.RED);
	}

	public static void recallBlocked(Player player) {
		actionBar(player, "message.herocraft.recall.blocked", ChatFormatting.RED);
	...
	public static void recallInventoryFull(Player player) {
		actionBar(player, "message.herocraft.recall.inventory_full", ChatFormatting.YELLOW);
	}
	...
	public static void hammerTakenByOwner(Player wielder) {
		actionBar(wielder, "message.herocraft.recall.taken_from_you", ChatFormatting.GRAY);
	}
	...
	public static void hammerlessFlightStarted(Player player) {
		actionBar(player, "message.herocraft.hammerless_flight.started", ChatFormatting.AQUA);
	}

	/** The grace ran out before Mjolnir came back -- flight has just ended. */
	public static void hammerlessFlightFaded(Player player) {
		actionBar(player, "message.herocraft.hammerless_flight.faded", ChatFormatting.GRAY);
	}
	...
	public static void bound(Player player) {
		...
		player.sendSystemMessage(Component.translatable("message.herocraft.bind.worthy")
				.withStyle(ChatFormatting.GOLD, ChatFormatting.BOLD));
		player.sendSystemMessage(Component.translatable("message.herocraft.bind.power")
				.withStyle(ChatFormatting.GRAY, ChatFormatting.ITALIC));
	}

	public static void unbound(Player player) {
		actionBar(player, "message.herocraft.bind.released", ChatFormatting.GRAY);
	}
	...
	public static void boundToSomeoneElse(Player player, String ownerName) {
		player.displayClientMessage(
				Component.translatable("message.herocraft.bind.taken",
