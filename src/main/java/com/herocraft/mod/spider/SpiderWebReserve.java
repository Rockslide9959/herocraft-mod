...
public final class SpiderWebReserve {
	 ...
	 * {@link com.herocraft.mod.symbiote.Symbiote}.
	 */
	...
	public static float maxFor(Player player) {
		return com.herocraft.mod.symbiote.Symbiote.hasSymbiote(player) ? MAX * SYMBIOTE_MULTIPLIER : MAX;
	}
	...
	public static void tick(ServerPlayer player) {
		...
		if (com.herocraft.mod.symbiote.Symbiote.isActive(player)
