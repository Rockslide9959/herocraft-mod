 ...
 * ({@code herocraft:spider_man_state}). Deliberately isolated from every Thor attachment, from
 * {@link com.herocraft.mod.hero.data.ExperimentalState} and from
 * {@link com.herocraft.mod.ironman.data.TonyStarkState}, exactly like those two are isolated from
 ...
 * {@link com.herocraft.mod.spider.SpiderMan} only re-save when something a viewer can actually see
...
public final class SpiderManState {
	...
	/** Organic webbing, 0..{@link com.herocraft.mod.spider.SpiderWebReserve#MAX}. */
	public float webReserve = com.herocraft.mod.spider.SpiderWebReserve.MAX;
	 ...
	 * com.herocraft.mod.spider.SpiderSwing#fire} so consecutive swings visibly alternate hands, and
	...
	public SpiderManState() {
		this(false, com.herocraft.mod.spider.SpiderWebReserve.MAX, 0L, 0L, new HashMap<>(), 0,
	...
	public static final Codec<SpiderManState> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			Codec.FLOAT.optionalFieldOf("web_reserve", com.herocraft.mod.spider.SpiderWebReserve.MAX)
