...
import com.herocraft.mod.ironman.suit.IronManSuitSummonManager;
...
public final class IronManCommand {
	...
	private static int part(CommandContext<CommandSourceStack> c, ServerPlayer target) {
		...
		boolean ok = com.herocraft.mod.ironman.suit.IronManSuitSummonManager.summonPart(target, suitId, type);
