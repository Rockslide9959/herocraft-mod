...
public final class IronManEnergy {
	...
	public static float stackEnergy(net.minecraft.world.item.ItemStack stack, String suitId) {
		Float v = stack.get(com.herocraft.mod.item.ModDataComponents.SUIT_ENERGY);
	...
	public static float stackIntegrity(net.minecraft.world.item.ItemStack stack, String suitId) {
		Float v = stack.get(com.herocraft.mod.item.ModDataComponents.SUIT_INTEGRITY);
	...
	public static void stampStack(net.minecraft.world.item.ItemStack stack, float energy, float integrity) {
		stack.set(com.herocraft.mod.item.ModDataComponents.SUIT_ENERGY, Math.max(0f, energy));
		stack.set(com.herocraft.mod.item.ModDataComponents.SUIT_INTEGRITY, Math.max(0f, integrity));
	}
