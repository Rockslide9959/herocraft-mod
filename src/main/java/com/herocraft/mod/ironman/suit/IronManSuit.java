 ...
 * {@code com.herocraft.mod.ironman.ability} / {@link IronManSuitSummonManager} /
...
public final class IronManSuit {
	...
	private IronManSuit(Builder b) {
		this.id = b.id;
		this.nameKey = "herocraft.ironman.suit." + b.id + ".name";
	...
	public static final class Builder {
		...
		private float maxIntegrity = com.herocraft.mod.ironman.IronManEnergy.MAX_INTEGRITY;
