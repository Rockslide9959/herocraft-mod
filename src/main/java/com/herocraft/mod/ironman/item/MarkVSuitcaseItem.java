...
public class MarkVSuitcaseItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
		...
		if (com.herocraft.mod.ironman.IronManArmor.wearingAnyIronMan(serverPlayer)) {
			String worn = com.herocraft.mod.ironman.IronManArmor.wornSuitId(serverPlayer);
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		tooltip.add(Component.translatable("item.herocraft.mark_v_suitcase.hint").withStyle(ChatFormatting.DARK_GRAY, ChatFormatting.ITALIC));
