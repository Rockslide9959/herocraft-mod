...
import static com.herocraft.mod.hero.AbilityActivation.CHARGE;
import static com.herocraft.mod.hero.AbilityActivation.CYCLE;
import static com.herocraft.mod.hero.AbilityActivation.HOLD;
import static com.herocraft.mod.hero.AbilityActivation.INSTANT;
import static com.herocraft.mod.hero.AbilityActivation.TOGGLE;
import static com.herocraft.mod.hero.AbilitySlot.SLOT_1;
import static com.herocraft.mod.hero.AbilitySlot.SLOT_2;
import static com.herocraft.mod.hero.AbilitySlot.SLOT_3;
import static com.herocraft.mod.hero.AbilitySlot.SLOT_4;
import static com.herocraft.mod.hero.AbilitySlot.SLOT_5;
import static com.herocraft.mod.hero.AbilitySlot.SLOT_6;

import com.herocraft.mod.hero.MutationTrigger.Kind;
...
final class PowerCatalog {
	...
	private static Power superStrength() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.PHYSICAL)
				...
				.trigger(MutationTrigger.of(Kind.ELECTRICAL_DISCHARGE, pk(k, "trigger"), "herocraft.device.overloaded_redstone_coil"))
				.combos("herocraft.combo.strength_flight", "herocraft.combo.geokinesis_strength")
				.build();
	}
	...
	private static Power laserVision() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ENERGY)
				...
				.ability(ab(k, "focused_beam", SLOT_2, INSTANT, 8 * S))
				.ability(ab(k, "heat_burst", SLOT_3, INSTANT, 5 * S))
				.ability(ab(k, "maximum_output", SLOT_4, INSTANT, 35 * S))
				...
				.trigger(MutationTrigger.of(Kind.HIGH_INTENSITY_LIGHT, pk(k, "trigger"), "herocraft.device.light_projector"))
				.combos("herocraft.combo.energy_absorption_laser")
				.build();
	}
	...
	private static Power flight() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.MOVEMENT)
				...
				.trigger(MutationTrigger.of(Kind.GRAVITY_DISTORTION, pk(k, "trigger"), "herocraft.device.gravity_plate"))
				.combos("herocraft.combo.strength_flight", "herocraft.combo.pyrokinesis_flight")
				.build();
	}
	...
	private static Power superSpeed() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.MOVEMENT)
				...
				.trigger(MutationTrigger.of(Kind.ELECTRICAL_DISCHARGE, pk(k, "trigger"), "herocraft.device.charged_copper_plates"))
				.combos("herocraft.combo.speed_electrokinesis")
				.build();
	}
	...
	private static Power geokinesis() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ELEMENTAL)
				...
				.ability(ab(k, "earthquake", SLOT_4, INSTANT, 35 * S))
				...
				.trigger(MutationTrigger.of(Kind.GEOLOGICAL_RESONANCE, pk(k, "trigger"), "herocraft.device.resonance_chamber"))
				.combos("herocraft.combo.geokinesis_strength")
				.build();
	}
	...
	private static Power crystalkinesis() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ELEMENTAL)
				...
				.ability(ab(k, "crystal_eruption", SLOT_4, INSTANT, 32 * S))
				...
				.trigger(MutationTrigger.of(Kind.AMETHYST_GEODE, pk(k, "trigger"), "herocraft.device.crystal_chamber"))
				.combos("herocraft.combo.cryokinesis_water")
				.build();
	}
	...
	private static Power electrokinesis() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ENERGY)
				...
				.ability(ab(k, "chain_lightning", SLOT_2, INSTANT, 8 * S))
				.ability(ab(k, "electric_dash", SLOT_3, INSTANT, 4 * S))
				.ability(ab(k, "electrical_storm", SLOT_4, INSTANT, 35 * S))
				...
				.trigger(MutationTrigger.of(Kind.ELECTRICAL_DISCHARGE, pk(k, "trigger"), "herocraft.device.overloaded_redstone_coil"))
				.combos("herocraft.combo.speed_electrokinesis", "herocraft.combo.water_electrokinesis")
				.build();
	}
	...
	private static Power pyrokinesis() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ELEMENTAL)
				...
				.ability(ab(k, "inferno", SLOT_4, INSTANT, 35 * S))
				...
				.combos("herocraft.combo.pyrokinesis_flight", "herocraft.combo.wind_fire")
				.build();
	}
	...
	private static Power telekinesis() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.MENTAL)
				...
				.trigger(MutationTrigger.of(Kind.PSIONIC_RESONANCE, pk(k, "trigger"), "herocraft.device.enchanting_resonance"))
				.combos("herocraft.combo.shadow_teleportation")
				.build();
	}
	...
	// ==================================================================================
	// 12 Super Regeneration (internal key kept as power_12_healing_factor for save compatibility)
	// ==================================================================================
	private static Power healingFactor() {
		String k = "power_12_healing_factor";
		return Power.Builder.of(Powers.id(k), PowerCategory.PHYSICAL)
				...
				.combos("herocraft.combo.speedster_set")
				.build();
	}
	...
	private static Power superDurability() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.PHYSICAL)
				...
				.trigger(MutationTrigger.of(Kind.EXPLOSION, pk(k, "trigger"), "herocraft.device.blast_chamber"))
				.combos("herocraft.combo.durability_size", "herocraft.combo.flying_brick_set")
				.build();
	}
	...
	private static Power sonicScream() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ENERGY)
				...
				.ability(ab(k, "supersonic_scream", SLOT_4, INSTANT, 40 * S))
				...
				.trigger(MutationTrigger.of(Kind.RESONANT_HORN, pk(k, "trigger"), "herocraft.device.resonant_chamber"))
				.combos("herocraft.combo.crystal_hero_set")
				.build();
	}
	...
	private static Power invisibilityLight() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.LIGHT)
				...
				.combos("herocraft.combo.psychic_set")
				.build();
	}
	...
	private static Power densityManipulation() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.MOLECULAR)
				...
				.trigger(MutationTrigger.of(Kind.MOLECULAR_COMPRESSION, pk(k, "trigger"), "herocraft.device.compression_chamber"))
				.combos("herocraft.combo.durability_size")
				.build();
	}
	...
	private static Power gravityManipulation() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.FORCE)
				...
				.trigger(MutationTrigger.of(Kind.GRAVITY_DISTORTION, pk(k, "trigger"), "herocraft.device.gravity_distortion_rig"))
				.build();
	}
	...
	private static Power windManipulation() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ELEMENTAL)
				...
				.trigger(MutationTrigger.of(Kind.PRESSURE_CHAMBER, pk(k, "trigger"), "herocraft.device.pressure_chamber"))
				.combos("herocraft.combo.wind_fire")
				.build();
	}
	...
	private static Power waterManipulation() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.ELEMENTAL)
				...
				.trigger(MutationTrigger.of(Kind.SUBMERSION, pk(k, "trigger"), "herocraft.device.hydrostatic_tank"))
				.combos("herocraft.combo.water_electrokinesis", "herocraft.combo.cryokinesis_water")
				.build();
	}
	...
	private static Power magneticManipulation() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.FORCE)
				...
				.trigger(MutationTrigger.of(Kind.MAGNETIC_FIELD, pk(k, "trigger"), "herocraft.device.electromagnetic_coil_pair"))
				.build();
	}
	...
	private static Power sizeManipulation() {
		...
		return Power.Builder.of(Powers.id(k), PowerCategory.MOLECULAR)
				...
				.trigger(MutationTrigger.of(Kind.MASS_COMPRESSION, pk(k, "trigger"), "herocraft.device.mass_compression_chamber"))
				.combos("herocraft.combo.durability_size")
				.build();
	}
}
