...
public enum SupervillainVariant {
	CHIMERA("chimera", 2.15f, "entity.herocraft.supervillain.chimera", "item.herocraft.chimera_core"),
	ARSENAL("arsenal", 1.95f, "entity.herocraft.supervillain.arsenal", "item.herocraft.arsenal_reactor"),
	OMEGA_MAGE("omega_mage", 1.75f, "entity.herocraft.supervillain.omega_mage", "item.herocraft.omega_crystal");
