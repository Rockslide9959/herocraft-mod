...
public final class ModArmorMaterials {
	 ...
	 * {@link com.herocraft.mod.punisher.PunisherArmorSet} still stacks projectile reduction + a little
	 ...
	 * com.herocraft.mod.ironman.item.RepulsorItem}), not GeckoLib. {@code symbiote_host_layer_1/2.png}
	...
	private static Holder<ArmorMaterial> registerWithLayer(String name, String layerName,
		...
		ArmorMaterial material = new ArmorMaterial(
				...
				equipSound,
				repairIngredient,
				List.of(new ArmorMaterial.Layer(HeroCraftMod.id(layerName))),
				toughness,
				knockbackResistance);
