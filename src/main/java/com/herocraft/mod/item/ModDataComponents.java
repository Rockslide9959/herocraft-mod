 ...
 * to (set via shift-right-click -- see {@link com.herocraft.mod.item.MjolnirItem}), independent of
 ...
 * {@link com.herocraft.mod.hammer.MjolnirRegistry} for the full scheme; in short, the id names one
...
public final class ModDataComponents {
	 ...
	 * {@link com.herocraft.mod.hammer.MjolnirRegistry#isStale}.
	 */
	...
	public static void initialize() {
		...
		// class; this method exists so HeroCraftMod has an explicit, readable init call.
	}
