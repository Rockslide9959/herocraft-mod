package com.herocraft.mod.punisher.satchel;

import java.util.ArrayList;
import java.util.List;

import com.herocraft.mod.punisher.Punisher;
import com.herocraft.mod.punisher.PunisherArmorSet;
...
public final class PunisherSatchel {
	...
	public static void open(ServerPlayer player) {
		...
		if (!PunisherArmorSet.fullSet(player)) {
			player.displayClientMessage(Component.translatable("message.herocraft.punisher.satchel_locked")
		...
		player.openMenu(new SimpleMenuProvider(
				...
				Component.translatable("container.herocraft.tactical_satchel")));
