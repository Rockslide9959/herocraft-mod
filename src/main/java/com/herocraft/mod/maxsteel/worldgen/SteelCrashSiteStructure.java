 ...
 * {@link com.herocraft.mod.maxsteel.entity.SteelEntity Steel} entity floating at its centre.
 *
 ...
 * ordinary datapack JSON ({@code data/herocraft/worldgen/structure(_set)/steel_crash_site.json}). Only
...
public class SteelCrashSiteStructure extends Structure {
	public static final ResourceKey<Structure> KEY =
			ResourceKey.create(Registries.STRUCTURE, HeroCraftMod.id("steel_crash_site"));
