 ...
 * com.herocraft.mod.maxsteel.entity.SteelEntity} persists like any other entity via ordinary chunk
...
public final class SteelCrashSpawnState extends SavedData {
	private static final String FILE_ID = HeroCraftMod.MOD_ID + "_steel_crash_sites";
