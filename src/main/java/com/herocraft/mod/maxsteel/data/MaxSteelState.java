package com.herocraft.mod.maxsteel.data;
 ...
 * ({@code herocraft:max_steel_state}). Isolated from every Thor / Tony Stark / Spider-Man /
 ...
 *
 * <p><b>Sync budget.</b> The mutators in {@link com.herocraft.mod.maxsteel.MaxSteel} only re-save when
...
public final class MaxSteelState {
	...
	/** T.U.R.B.O. Energy, 0..{@link com.herocraft.mod.maxsteel.MaxSteelConfig#MAX_TURBO_ENERGY}. */
	public float turboEnergy = com.herocraft.mod.maxsteel.MaxSteelConfig.MAX_TURBO_ENERGY;
	...
	public int transformDurationTicks = com.herocraft.mod.maxsteel.MaxSteelConfig.TRANSFORM_TICKS;
	...
	public MaxSteelState() {
		this(false, com.herocraft.mod.maxsteel.MaxSteelConfig.MAX_TURBO_ENERGY, false,
				MaxSteelMode.BASE.ordinal(), DIR_IDLE, 0L,
				com.herocraft.mod.maxsteel.MaxSteelConfig.TRANSFORM_TICKS, new HashMap<>(),
				0L, 0L, 0L, 0L, 0L, -1);
	}
	...
	public static final Codec<MaxSteelState> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			Codec.FLOAT.optionalFieldOf("turbo_energy", com.herocraft.mod.maxsteel.MaxSteelConfig.MAX_TURBO_ENERGY)
			...
			Codec.INT.optionalFieldOf("transform_duration_ticks",
					com.herocraft.mod.maxsteel.MaxSteelConfig.TRANSFORM_TICKS).forGetter(s -> s.transformDurationTicks),
