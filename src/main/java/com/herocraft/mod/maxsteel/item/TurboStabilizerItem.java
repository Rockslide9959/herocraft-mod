package com.herocraft.mod.maxsteel.item;
 ...
 * behaviour here -- {@link com.herocraft.mod.maxsteel.entity.SteelEntity}'s right-click handler checks
 * for and consumes it.
 */
public class TurboStabilizerItem extends Item {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		tooltip.add(Component.translatable("item.herocraft.turbo_stabilizer.tip1").withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.translatable("item.herocraft.turbo_stabilizer.tip2").withStyle(ChatFormatting.DARK_AQUA));
