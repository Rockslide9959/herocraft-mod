...
public class BossTrophyItem extends Item {
	...
	public Component getName(ItemStack stack) {
		...
		return Component.translatable(finalBoss
				? "item.herocraft.final_boss_trophy.named"
				: "item.herocraft.boss_trophy.named", BossPowers.displayName(key));
	}

	@Override
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		super.appendHoverText(stack, context, tooltip, flag);
		tooltip.add(Component.translatable("item.herocraft.boss_trophy.hint")
