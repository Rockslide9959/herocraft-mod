...
public class NecroticBladeItem extends SwordItem {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		tooltip.add(Component.translatable("item.herocraft.necrotic_blade.wither",
				Math.round(EventConfig.raid().necroticWitherChance * 100)).withStyle(ChatFormatting.DARK_PURPLE));
		tooltip.add(Component.translatable("item.herocraft.necrotic_blade.stacks", maxStacks())
