 ...
 * ({@link com.herocraft.mod.network.FirearmActionPayload}).
 */
public class FirearmItem extends Item {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		tooltip.add(Component.translatable("firearm.herocraft.tooltip.ammo",
				Component.translatable("firearm.herocraft.ammo." + d.ammo.lower())).withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.translatable("firearm.herocraft.tooltip.magazine", mag, d.magazineSize)
				.withStyle(ChatFormatting.DARK_GRAY));
		tooltip.add(Component.translatable("firearm.herocraft.tooltip.damage",
				fmt(d.bodyDamage), fmt(d.headDamage)).withStyle(ChatFormatting.DARK_GRAY));
		tooltip.add(Component.translatable(d.automatic
				? "firearm.herocraft.tooltip.automatic" : "firearm.herocraft.tooltip.semi")
				.withStyle(ChatFormatting.DARK_GRAY));
		tooltip.add(Component.translatable("firearm.herocraft.tooltip.controls").withStyle(ChatFormatting.DARK_GRAY));
	}
