 ...
 * ({@link com.projecthero.mod.ironman.fabricator.StarkFabricatorBlockEntity}) and the suit platform
 * ({@link com.projecthero.mod.ironman.fabricator.IronManSuitPlatformBlockEntity}) both refuse to open
 ...
 * ({@link com.projecthero.mod.ironman.item.ArcReactorItem}), so gating it would make the whole tree
...
public final class IronManCrafting {
	...
	public static void warnLocked(ServerPlayer player) {
		...
		player.displayClientMessage(Component.translatable("message.projecthero.ironman.craft_requires_tony_stark")
