...
public class ArcReactorItem extends Item {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		tooltip.add(Component.translatable("item.projecthero.arc_reactor.line1").withStyle(ChatFormatting.AQUA, ChatFormatting.BOLD));
		tooltip.add(Component.empty());
		tooltip.add(Component.translatable("item.projecthero.arc_reactor.line2").withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.translatable("item.projecthero.arc_reactor.line3").withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.translatable("item.projecthero.arc_reactor.line4").withStyle(ChatFormatting.GRAY));
		tooltip.add(Component.empty());
		tooltip.add(Component.translatable("item.projecthero.arc_reactor.unlock").withStyle(ChatFormatting.DARK_GRAY));
		tooltip.add(Component.translatable("projecthero.ironman.power.tony_stark.name").withStyle(ChatFormatting.GOLD));
	}
}
