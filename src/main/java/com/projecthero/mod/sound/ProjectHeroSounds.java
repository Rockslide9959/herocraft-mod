package com.projecthero.mod.sound;
 ...
 *
 * <p>None of these ship a ProjectHero-authored .ogg (custom Thor-hammer audio is outside what this
 * environment can author or legally source), and for a long time they pointed at
 * {@code assets/projecthero/sounds/mjolnir/*.ogg} paths with nothing on disk -- so all three events were
 ...
 *
 * <p>To replace them with bespoke audio: drop the recording at {@code assets/projecthero/sounds/mjolnir/}
 * and point that event's {@code sounds} entry back at {@code projecthero:mjolnir/<name>}. Nothing in
 ...
 */
public final class ProjectHeroSounds {
	...
	private ProjectHeroSounds() {
	}

	public static void initialize() {
		// Classes are loaded (and the events registered) simply by referencing this class; this
		// method exists so ProjectHeroMod has an explicit, readable init call.
	}
