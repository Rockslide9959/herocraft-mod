 ...
 * first and tried to study it. A {@link com.projecthero.mod.symbiote.entity.SymbioteEntity} sits
 ...
 * -- same convention as the other ProjectHero structures.
 */
public class SymbioteLabStructure extends Structure {
	public static final ResourceKey<Structure> KEY =
			ResourceKey.create(Registries.STRUCTURE, ProjectHeroMod.id("symbiote_lab"));
