...
import static com.projecthero.mod.firearm.FirearmData.s;

/**
 * The firearm data registry. One entry per weapon id; {@link com.projecthero.mod.firearm.item.FirearmItem}
...
public final class Firearms {
	...
	static {
		...
		register(FirearmData.builder(SHOTGUN, AmmoKind.SHOTGUN)
				...
				.shellReload(true)
				.spread(6.5f)                // wide cone (v0.9.22: slightly wider, was 5.5)
	...
	public static FirearmData of(ItemStack stack) {
		return stack.getItem() instanceof com.projecthero.mod.firearm.item.FirearmItem f ? get(f.firearmId()) : null;
	}
