...
public enum AmmoKind {
	PISTOL(() -> com.projecthero.mod.firearm.item.FirearmItems.PISTOL_AMMO),
	RIFLE(() -> com.projecthero.mod.firearm.item.FirearmItems.RIFLE_AMMO),
	SHOTGUN(() -> com.projecthero.mod.firearm.item.FirearmItems.SHOTGUN_SHELL),
	SNIPER(() -> com.projecthero.mod.firearm.item.FirearmItems.SNIPER_AMMO);
