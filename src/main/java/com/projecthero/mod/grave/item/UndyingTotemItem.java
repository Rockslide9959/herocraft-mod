...
public class UndyingTotemItem extends Item {
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
		...
		tooltip.add(Component.translatable("item.projecthero.undying_totem.charges", charges(stack), maxCharges())
				.withStyle(ChatFormatting.GOLD));
		tooltip.add(Component.translatable("item.projecthero.undying_totem.hint")
