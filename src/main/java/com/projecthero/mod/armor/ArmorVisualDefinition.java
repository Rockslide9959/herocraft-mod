 ...
 * touching {@link com.projecthero.mod.client.render.SuperheroArmorModel} or the renderer.
 *
 * @param geometry  {@code projecthero:geo/<name>.geo.json}
 * @param texture   {@code projecthero:textures/armor/<name>.png}
 * @param animation {@code projecthero:animations/<name>.animation.json}
 */
