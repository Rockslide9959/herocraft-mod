 ...
 * animation"; the shared {@link com.projecthero.mod.client.render.SuperheroArmorModel} just asks this
 * class.
 *
 ...
 * {@link com.projecthero.mod.armor.SuperheroArmorItem} whose {@code armorSetId()} returns a new id, and
...
public final class SuperheroArmorVisuals {
	...
	public static final ResourceLocation SHARED_GEO = ProjectHeroMod.id("geo/crimson_vanguard.geo.json");
	/** Shared animation file (idle / assemble / disassemble / helmet / repulsor / flight / landing). */
	public static final ResourceLocation SHARED_ANIMATION = ProjectHeroMod.id("animations/crimson_vanguard.animation.json");

	/** Used for any set that has not been registered. */
	public static final ArmorVisualDefinition DEFAULT = new ArmorVisualDefinition(
			SHARED_GEO, ProjectHeroMod.id("textures/armor/crimson_vanguard.png"), SHARED_ANIMATION);
