...
public final class MaxSteelFeedback {
	...
	public static void noEnergy(ServerPlayer player, float required) {
		player.displayClientMessage(Component.translatable("message.projecthero.max_steel.no_energy",
	...
	public static void onCooldown(ServerPlayer player, String abilityKey, int ticksRemaining) {
		player.displayClientMessage(Component.translatable("message.projecthero.ability.on_cooldown",
				Component.translatable("projecthero.max_steel.ability." + abilityKey),
