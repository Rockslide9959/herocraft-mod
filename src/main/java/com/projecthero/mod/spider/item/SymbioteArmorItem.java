 ...
 * {@link com.projecthero.mod.symbiote.SymbioteSuit} when the Symbiote is activated (H) and
 ...
 * com.projecthero.mod.spider.SpiderMask#wearingHood} -- then covers the Symbiote suit for free. Only the
