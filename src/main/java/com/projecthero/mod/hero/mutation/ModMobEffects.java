 ...
 * for (the power's index in {@link com.projecthero.mod.hero.Powers#all()}), which is how one effect
...
public final class ModMobEffects {
	...
	public static final Holder<MobEffect> UNSTABLE_MUTATION = Registry.registerForHolder(
			BuiltInRegistries.MOB_EFFECT, ProjectHeroMod.id("unstable_mutation"), new UnstableMutation());
