...
/**
 * Super Strength: the mutant's bare hands break and harvest blocks as though holding stone tools --
 * for both mining speed and whether the block actually drops its items.
 *
...
public final class StrengthBareHands {
	...
	/** Whether the stone-hand rule applies to {@code player} right now (owns the power, main hand empty). */
