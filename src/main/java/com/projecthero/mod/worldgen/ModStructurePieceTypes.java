...
public final class ModStructurePieceTypes {
	...
	public static final StructurePieceType STEEL_CRASH_SITE =
			register("steel_crash_site", com.projecthero.mod.maxsteel.worldgen.SteelCrashSitePiece::new);
	public static final StructurePieceType VIGILANTE_SAFEHOUSE =
			register("vigilante_safehouse", com.projecthero.mod.punisher.worldgen.VigilanteSafehousePiece::new);
	...
	private static StructurePieceType register(String path, StructurePieceType type) {
		ResourceKey<StructurePieceType> key = ResourceKey.create(Registries.STRUCTURE_PIECE, ProjectHeroMod.id(path));
