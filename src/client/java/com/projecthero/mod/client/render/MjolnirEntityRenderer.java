...
public final class MjolnirEntityRenderer extends EntityRenderer<MjolnirEntity> {
	 ...
	 *
	 * <p>{@link com.projecthero.mod.item.ModItems#MJOLNIR}'s own model bakes a -45 degree Z rotation into
	 ...
	 * entity renders {@link com.projecthero.mod.item.ModItems#MJOLNIR_THROWN} instead -- identical
