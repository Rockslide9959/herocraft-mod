...
public final class RaidEntityRenderers {
	...
	private static final ResourceLocation CURSED_ZOMBIE = ProjectHeroMod.id("textures/entity/cursed_zombie.png");
	private static final ResourceLocation ARMOURED_ZOMBIE = ProjectHeroMod.id("textures/entity/armoured_zombie.png");
	private static final ResourceLocation ACID_ZOMBIE = ProjectHeroMod.id("textures/entity/acid_zombie.png");
	private static final ResourceLocation JUGGERNAUT_ZOMBIE = ProjectHeroMod.id("textures/entity/juggernaut_zombie.png");
	private static final ResourceLocation SWORD_SKELETON = ProjectHeroMod.id("textures/entity/sword_skeleton.png");
	private static final ResourceLocation PILLAGER_SPY = ProjectHeroMod.id("textures/entity/pillager_spy.png");
