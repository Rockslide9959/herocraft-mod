...
public final class PunisherHud {
	...
	public static void render(GuiGraphics g, DeltaTracker delta) {
		...
		if (s.adrenalineUntil > now) {
			g.drawString(mc.font, Component.translatable("hud.projecthero.punisher.adrenaline",
					(int) ((s.adrenalineUntil - now + 19) / 20)).withStyle(ChatFormatting.RED), x0, line, 0xFFFF5555, true);
			line += 10;
		}
		if (s.suppressiveUntil > now) {
			g.drawString(mc.font, Component.translatable("hud.projecthero.punisher.suppressive",
