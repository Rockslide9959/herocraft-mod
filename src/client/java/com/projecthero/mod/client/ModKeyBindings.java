 ...
 * while holding Mjolnir -- see {@link ProjectHeroModClient}. Experimental Flight is a slot ability like
 * any other.
 *
 ...
 * new slot keys via {@link com.projecthero.mod.item.MjolnirTooltip}.
 */
public final class ModKeyBindings {
	/** Exact display string required by the spec (note the intentional spelling). */
	private static final String CATEGORY = "key.category.projecthero.abilities";

	public static final KeyMapping ABILITY_1 = new KeyMapping(
			"key.projecthero.ability_1", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_R, CATEGORY);
	...
	public static final KeyMapping POWER_SELECT = new KeyMapping(
			"key.projecthero.power_select", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_H, CATEGORY);
	...
	public static final KeyMapping POWER_INFO = new KeyMapping(
			"key.projecthero.power_info", InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_I, CATEGORY);
