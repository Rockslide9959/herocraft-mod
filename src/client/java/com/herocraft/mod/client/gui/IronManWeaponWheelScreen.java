...
import com.herocraft.mod.network.IronManWeaponWheelPayload;
...
public final class IronManWeaponWheelScreen extends Screen {
	...
	public IronManWeaponWheelScreen() {
		super(Component.translatable("screen.herocraft.weapon_wheel.title"));
	}
	...
	public void render(GuiGraphics g, int mouseX, int mouseY, float partialTick) {
		...
		for (int i = 0; i < SECTORS.length; i++) {
			...
			Component name = Component.translatable("hud.herocraft.ironman.ability." + sector);
		...
		g.drawCenteredString(this.font, Component.translatable("screen.herocraft.weapon_wheel.hint"),
