...
import com.herocraft.mod.network.PunisherArsenalPayload;
...
public final class ArsenalWheelScreen extends Screen {
	...
	public ArsenalWheelScreen() {
		super(Component.translatable("screen.herocraft.arsenal.title"));
	...
	public void render(GuiGraphics g, int mouseX, int mouseY, float partialTick) {
		...
		for (int i = 0; i < n; i++) {
			...
			g.drawCenteredString(this.font, Component.translatable("item.herocraft." + weapons.get(i)),
					x, y - 4, isHover ? 0xFFFFFFFF : 0xFFC8C8C8);
		}
		g.drawCenteredString(this.font, Component.translatable("screen.herocraft.arsenal.hint"),
