...
import com.herocraft.mod.power.StormEnergy;
...
public final class ThorHud {
	...
	private static void renderKit(GuiGraphics graphics, Minecraft client, Player player) {
		...
		graphics.drawString(client.font, Component.translatable("herocraft.guide.thor")
		...
		for (int i = 0; i < 6; i++) {
			...
			if (expanded) {
				Component name = Component.translatable("herocraft.thor.ability." + SLOT_NAME_KEYS[i]);
		...
		graphics.drawString(client.font, Component.translatable("hud.herocraft.thor.storm_energy",
	...
	private static void renderWrathCharge(GuiGraphics graphics, Minecraft client, Player player) {
		...
		Component label = Component.translatable("hud.herocraft.thor.wrath_charge")
	...
	private static void renderHammerlessFlightCountdown(GuiGraphics graphics, Minecraft client, int ticks) {
		...
		Component text = Component.translatable("message.herocraft.hammerless_flight.countdown",
