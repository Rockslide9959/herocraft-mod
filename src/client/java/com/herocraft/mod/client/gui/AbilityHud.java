...
import com.herocraft.mod.hero.AbilityActivation;
...
public final class AbilityHud {
	...
	private static List<Meter> collectMeters(ExperimentalState state, Power power) {
		...
		for (var e : state.resources.entrySet()) {
			...
			if (name.equals("flight") && (!com.herocraft.mod.hero.power.HeroFlight.hasFlight(power)
					|| com.herocraft.mod.hero.power.HeroFlight.infinite(power))) {
