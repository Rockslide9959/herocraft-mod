...
import com.herocraft.mod.client.gui.AbilityHud;
import com.herocraft.mod.client.gui.PowerWheelScreen;
import com.herocraft.mod.client.gui.ThorHud;
import com.herocraft.mod.client.render.ModEntityRenderers;
import com.herocraft.mod.client.sound.ThorFlightSoundInstance;
import com.herocraft.mod.item.MjolnirTooltip;
import com.herocraft.mod.network.AbilityInputPayload;
import com.herocraft.mod.network.ThorActionPayload;
...
public class HeroCraftModClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		com.herocraft.mod.hero.guide.HeroPackGuideItem.clientOpener =
				() -> Minecraft.getInstance().setScreen(new com.herocraft.mod.client.gui.HeroPackGuideScreen());

		HudRenderCallback.EVENT.register(ThorHud::render);
		HudRenderCallback.EVENT.register(AbilityHud::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.IronManHud::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.RaidHud::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.SpiderHud::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.MaxSteelHud::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.FirearmHud::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.ScopeOverlay::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.PunisherHud::render);
		HudRenderCallback.EVENT.register(com.herocraft.mod.client.gui.SymbioteHud::render);

		net.minecraft.client.gui.screens.MenuScreens.register(
				com.herocraft.mod.ironman.IronManBlocks.STARK_FABRICATOR_MENU,
				com.herocraft.mod.client.gui.StarkFabricatorScreen::new);
		net.minecraft.client.gui.screens.MenuScreens.register(
				com.herocraft.mod.ironman.IronManBlocks.SUIT_PLATFORM_MENU,
				com.herocraft.mod.client.gui.IronManSuitPlatformScreen::new);
		net.fabricmc.fabric.api.client.rendering.v1.BlockEntityRendererRegistry.register(
				com.herocraft.mod.ironman.IronManBlocks.SUIT_PLATFORM_BE,
				com.herocraft.mod.client.render.IronManSuitPlatformRenderer::new);
		com.herocraft.mod.client.render.IronManEntityRenderers.initialize();
		com.herocraft.mod.client.render.RaidEntityRenderers.initialize();
		com.herocraft.mod.client.render.TitanEntityRenderers.initialize();
		com.herocraft.mod.client.render.PunisherEntityRenderers.initialize();
		com.herocraft.mod.client.render.SuperheroFirstPersonArm.initialize();
		IronManBeamClient.register();
		com.herocraft.mod.client.spider.SpiderWebLineRenderer.initialize();
		...
		com.herocraft.mod.armor.SuperheroArmorItem.rendererFactory =
				consumer -> consumer.accept(new com.herocraft.mod.client.render.SuperheroArmorRenderProvider());

		// Iron Man call-armour picker (spec "changes 9"): server sends the list, we open the screen.
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.IronManSuitListPayload.TYPE,
				(payload, context) -> context.client().execute(() -> context.client().setScreen(
						new com.herocraft.mod.client.gui.IronManSuitCallScreen(payload.options()))));

		// Mark 7 weapon wheel ("changes 16"): server tells us to open it (empty ability string).
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.IronManWeaponWheelPayload.TYPE,
				(payload, context) -> context.client().execute(() -> context.client().setScreen(
						new com.herocraft.mod.client.gui.IronManWeaponWheelScreen())));

		// Blank Blueprint picker ("changes 21"): server sends the mark list, we open the screen.
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.IronManBlueprintPickerPayload.TYPE,
				(payload, context) -> context.client().execute(() -> context.client().setScreen(
						new com.herocraft.mod.client.gui.BlankBlueprintScreen(payload.entries()))));

		net.fabricmc.fabric.api.client.rendering.v1.EntityModelLayerRegistry.registerModelLayer(
				com.herocraft.mod.client.maxsteel.MaxSteelWingsModel.LAYER,
				com.herocraft.mod.client.maxsteel.MaxSteelWingsModel::createLayer);
		...
		net.fabricmc.fabric.api.client.rendering.v1.LivingEntityFeatureRendererRegistrationCallback.EVENT.register(
				(entityType, entityRenderer, registrationHelper, context) -> {
					if (entityRenderer instanceof net.minecraft.client.renderer.entity.player.PlayerRenderer playerRenderer) {
						registrationHelper.register(new com.herocraft.mod.client.render.ArcReactorLayer(
								playerRenderer, context.getItemRenderer()));
						registrationHelper.register(new com.herocraft.mod.client.maxsteel.MaxSteelWingsLayer(
		...
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.RaidSkyPayload.TYPE,
				(payload, context) -> context.client().execute(
						() -> com.herocraft.mod.client.gui.RaidSkyTint.accept(payload)));

		// Max Steel: Steel's directional threat warning.
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.MaxSteelWarningPayload.TYPE,
				(payload, context) -> context.client().execute(
						() -> com.herocraft.mod.client.gui.MaxSteelHud.flashWarning(payload.yawToThreat())));

		// Spider-Sense: the pre-emptive directional danger warning.
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.SpiderSenseWarningPayload.TYPE,
				(payload, context) -> context.client().execute(
						() -> com.herocraft.mod.client.gui.SpiderHud.flashWarning(
		...
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.SpiderSenseGlowPayload.TYPE,
				(payload, context) -> context.client().execute(() -> {
					long now = context.client().level != null ? context.client().level.getGameTime() : 0L;
					com.herocraft.mod.client.spider.SpiderSenseGlowClient.accept(payload.ids(), now);
				}));
		...
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.SpiderClimbGrabPayload.TYPE,
				(payload, context) -> context.client().execute(() -> {
					net.minecraft.client.player.LocalPlayer p = context.client().player;
					if (p != null) {
						p.getAttachedOrCreate(com.herocraft.mod.attachment.ModAttachments.SPIDER_CLIMB_LOCAL)
								.setGrabIntent(true);
					}
				}));

		// Firearms: server-accepted shot -> recoil kick; headshot -> HUD flash.
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.FirearmShotPayload.TYPE,
				(payload, context) -> context.client().execute(
						() -> com.herocraft.mod.client.firearm.FirearmClient.applyKick(payload.verticalKick())));
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.FirearmHeadshotPayload.TYPE,
				(payload, context) -> context.client().execute(
						com.herocraft.mod.client.gui.FirearmHud::flashHeadshot));
		// Punisher: server asked us to open the Arsenal wheel.
		ClientPlayNetworking.registerGlobalReceiver(com.herocraft.mod.network.PunisherArsenalOpenPayload.TYPE,
				(payload, context) -> context.client().execute(() -> {
					if (context.client().screen == null) {
						context.client().setScreen(new com.herocraft.mod.client.gui.ArsenalWheelScreen());
					}
				}));

		ClientTickEvents.END_CLIENT_TICK.register(client ->
				com.herocraft.mod.client.firearm.FirearmClient.clientTick(client));
		ClientTickEvents.END_CLIENT_TICK.register(HeroCraftModClient::handleKeyBinds);
		...
		ClientTickEvents.END_CLIENT_TICK.register(com.herocraft.mod.client.spider.SpiderInputClient::clientTick);
		ClientTickEvents.END_CLIENT_TICK.register(com.herocraft.mod.client.symbiote.SymbioteFxClient::clientTick);
	}
	...
	private static void handleKeyBinds(Minecraft client) {
		...
		if (client.player == null) {
			...
			com.herocraft.mod.client.gui.RaidSkyTint.reset();
		...
		boolean holdingFirearm = client.player.getMainHandItem().getItem()
				instanceof com.herocraft.mod.firearm.item.FirearmItem;
	...
	private static void handleFirearmAbilityOne(KeyMapping key) {
		...
		if (down && !slotWasDown[0]) {
			...
			if (firearmAbilityOneSentPress) {
				...
				ClientPlayNetworking.send(new com.herocraft.mod.network.FirearmActionPayload(
						com.herocraft.mod.network.FirearmActionPayload.Action.RELOAD));
			}
	...
	private static void handlePowerSelect(Minecraft client) {
		...
		if (down && !powerSelectWasDown) {
			...
			if (client.player != null && wearingAnyIronMan(client.player)) {
				ClientPlayNetworking.send(new com.herocraft.mod.network.IronManActionPayload(
						com.herocraft.mod.network.IronManActionPayload.Action.TOGGLE_FACEPLATE));
			} else if (client.player != null && com.herocraft.mod.maxsteel.MaxSteel.isTransformed(client.player)) {
				// v0.6.17: Shift+H powers down; plain H toggles the helmet.
				ClientPlayNetworking.send(new com.herocraft.mod.network.MaxSteelActionPayload(
						Screen.hasShiftDown()
								? com.herocraft.mod.network.MaxSteelActionPayload.Action.POWER_DOWN
								: com.herocraft.mod.network.MaxSteelActionPayload.Action.TOGGLE_HELMET));
			} else if (client.player != null
					&& com.herocraft.mod.symbiote.Symbiote.canToggle(client.player)) {
				...
				if (Screen.hasShiftDown()
						&& com.herocraft.mod.spider.SpiderMask.wearingHood(client.player)) {
					ClientPlayNetworking.send(new com.herocraft.mod.network.SpiderActionPayload(
							com.herocraft.mod.network.SpiderActionPayload.Action.TOGGLE_MASK));
				} else {
					ClientPlayNetworking.send(new com.herocraft.mod.network.SpiderActionPayload(
							com.herocraft.mod.network.SpiderActionPayload.Action.TOGGLE_SYMBIOTE));
				}
			} else if (client.player != null && com.herocraft.mod.spider.SpiderMask.wearingHood(client.player)) {
	...
	private static void handleMaxSteelTransform(Minecraft client) {
		...
		if (down && !maxSteelTransformWasDown && client.player != null
				&& com.herocraft.mod.maxsteel.MaxSteel.hasPower(client.player)) {
			ClientPlayNetworking.send(new com.herocraft.mod.network.MaxSteelActionPayload(
					com.herocraft.mod.network.MaxSteelActionPayload.Action.TRANSFORM_TOGGLE));
		}
	...
	private static void handlePowerInfo(Minecraft client) {
		...
		if (down && !powerInfoWasDown) {
			client.setScreen(new com.herocraft.mod.client.gui.PowerInfoScreen());
		}
	...
	private static void handleDoubleJump(Minecraft client, LocalPlayer player) {
		...
		if (!player.onGround() && player.getItemBySlot(net.minecraft.world.entity.EquipmentSlot.FEET)
				.is(com.herocraft.mod.ironman.item.IronManItems.REPULSOR)) {
			ticksSinceJumpPress = Integer.MAX_VALUE;
			ClientPlayNetworking.send(new com.herocraft.mod.network.IronManActionPayload(
					com.herocraft.mod.network.IronManActionPayload.Action.TOGGLE_FLIGHT));
			return;
		}
		...
		com.herocraft.mod.ironman.data.TonyStarkState stark =
				player.getAttachedOrElse(com.herocraft.mod.attachment.ModAttachments.TONY_STARK_STATE, null);
		...
		if (!player.onGround() && wearingIronMan) {
			...
			ticksSinceJumpPress = Integer.MAX_VALUE;
			ClientPlayNetworking.send(new com.herocraft.mod.network.IronManActionPayload(
					com.herocraft.mod.network.IronManActionPayload.Action.SUMMON_SUIT));
		}
	}
