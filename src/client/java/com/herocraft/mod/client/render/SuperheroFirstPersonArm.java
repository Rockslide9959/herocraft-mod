...
import com.herocraft.mod.armor.SuperheroArmorVisuals;
...
/**
 * The first-person forearm for every {@link com.herocraft.mod.armor.SuperheroArmorItem} set. It draws
 * <em>over</em> the bare player hand (the second/sleeve layer is hidden by
 * {@link com.herocraft.mod.client.mixin.PlayerModelMixin}) whenever the local player wears a superhero
 * chestplate -- see {@link com.herocraft.mod.client.mixin.PlayerRendererHandMixin}.
 *
...
public final class SuperheroFirstPersonArm {
	private static final ModelLayerLocation LAYER =
			new ModelLayerLocation(HeroCraftMod.id("superhero_first_person_arm"), "main");
	 ...
	 *
	 * @param armorSetId {@link com.herocraft.mod.armor.SuperheroArmorItem#armorSetId()} of the worn chestplate
	 */
