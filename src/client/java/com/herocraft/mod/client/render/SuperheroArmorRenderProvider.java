...
/**
 * Client-only bridge between a common {@link com.herocraft.mod.armor.SuperheroArmorItem} and its
 ...
 * {@code SuperheroArmorItem.rendererFactory} from {@code HeroCraftModClient} so {@code src/main}
