...
/**
 * Real, automated regression coverage for ProjectHero's server-side logic, run inside an actual
 ...
 * {@code ServerTickEvents.END_SERVER_TICK} handler from {@code ProjectHeroMod} -- not a hand-rolled
 ...
 */
public class ProjectHeroGameTests implements FabricGameTest {
	...
	public void hammerlessGraceEndsWhenTimerExpires(GameTestHelper helper) {
		...
		// REAL globally-registered end-of-server-tick handler (ProjectHeroMod's
