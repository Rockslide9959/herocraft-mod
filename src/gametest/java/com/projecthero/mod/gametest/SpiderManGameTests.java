...
import com.projecthero.mod.spider.SpiderAnchorSearch;
import com.projecthero.mod.spider.SpiderMan;
import com.projecthero.mod.spider.SpiderManAbilityManager;
import com.projecthero.mod.spider.SpiderSense;
...
public class SpiderManGameTests implements FabricGameTest {
	...
	public void existingAdhesionSavesKeepWorking(GameTestHelper helper) {
		...
		helper.assertTrue(ExperimentalPowers.isToggled(player, adhesion(),
				adhesion().ability(com.projecthero.mod.hero.AbilitySlot.SLOT_6)),
				"Adhesion Mode should still toggle on an existing save");
		helper.assertTrue(com.projecthero.mod.spider.SpiderClimb.profile(player)
				== com.projecthero.mod.spider.SpiderClimb.Profile.ADHESION,
	...
	public void spiderManGetsStrongerClimbingThanAdhesion(GameTestHelper helper) {
		...
		com.projecthero.mod.spider.SpiderClimb.Profile p = com.projecthero.mod.spider.SpiderClimb.profile(player);
		helper.assertTrue(p == com.projecthero.mod.spider.SpiderClimb.Profile.SPIDER_MAN,
				"Spider-Man should always have the full climbing profile, with no toggle needed");
		helper.assertTrue(p.climbSpeed() > com.projecthero.mod.spider.SpiderClimb.Profile.ADHESION.climbSpeed(),
				"Spider-Man should climb faster than basic Spider Adhesion");
		helper.assertTrue(p.graceTicks() > com.projecthero.mod.spider.SpiderClimb.Profile.ADHESION.graceTicks(),
	...
	public void powerSuppressorStripsSpiderMan(GameTestHelper helper) {
		...
		com.projecthero.mod.item.ModItems.POWER_SUPPRESSOR.use(player.level(), player, InteractionHand.MAIN_HAND);
