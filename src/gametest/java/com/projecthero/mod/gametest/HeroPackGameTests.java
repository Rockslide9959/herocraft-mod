...
public class HeroPackGameTests implements FabricGameTest {
	...
	public void guideChaptersBuildFromRegistry(GameTestHelper helper) {
		...
		// 18 framing chapters (overview, mutation, structures, devices, combos, Thor, Iron Man,
		// Spider-Man, Max Steel, Punisher, Green Lantern, Symbiote, Zombie Raid, Supervillain Raid,
		// Titan, Squads, Wolverine, Titan Shifter) + one per power
		helper.assertTrue(chapters.size() == 18 + Powers.count(),
