...
public class SymbioteGameTests implements FabricGameTest {
	...
	public void ordinaryPlayerCanBondAndToggle(GameTestHelper helper) {
		...
		helper.assertTrue(
				player.getItemBySlot(EquipmentSlot.CHEST).getItem()
						instanceof com.projecthero.mod.symbiote.item.SymbioteHostArmorItem,
	...
	public void worldgenAndEntityTypesAreRegistered(GameTestHelper helper) {
		helper.assertTrue(net.minecraft.core.registries.BuiltInRegistries.ENTITY_TYPE.containsKey(
				com.projecthero.mod.ProjectHeroMod.id("symbiote")), "the Symbiote entity type must be registered");
		helper.assertTrue(net.minecraft.core.registries.BuiltInRegistries.STRUCTURE_TYPE.containsKey(
				com.projecthero.mod.ProjectHeroMod.id("symbiote_meteor")), "symbiote_meteor structure type");
		helper.assertTrue(net.minecraft.core.registries.BuiltInRegistries.STRUCTURE_TYPE.containsKey(
				com.projecthero.mod.ProjectHeroMod.id("symbiote_lab")), "symbiote_lab structure type");
		helper.succeed();
	}
	...
	public void symbioteHostBuffsAndKeepsTheMob(GameTestHelper helper) {
		...
		com.projecthero.mod.symbiote.SymbioteHost.mark(zombie);

		helper.assertTrue(com.projecthero.mod.symbiote.SymbioteHost.is(zombie), "the mob should be tagged");
	...
	public void bondingKeepsSpiderManAndUsesTheBlackSuit(GameTestHelper helper) {
		...
		helper.assertTrue(com.projecthero.mod.symbiote.SymbioteHostType.of(spider)
				== com.projecthero.mod.symbiote.SymbioteHostType.SPIDER_MAN, "host type resolves to Black Suit");
		helper.succeed();
	}
	...
	public void bondingPurgesAnIncompatibleHeroTierPower(GameTestHelper helper) {
		...
		helper.assertTrue(com.projecthero.mod.ironman.TonyStark.hasPower(player), "sanity: Tony Stark granted");
	...
	public void bondingPurgesAnExperimentalPower(GameTestHelper helper) {
		...
		helper.assertTrue(com.projecthero.mod.hero.HeroTiers.hasExperimental(player), "sanity: power granted");
	...
	public void normalHostAbilitiesRespectCooldown(GameTestHelper helper) {
		...
		Symbiote.toggle(player);
		forceSettle(player);
		helper.assertTrue(com.projecthero.mod.symbiote.SymbioteAbilityManager.hasContext(player),
		...
		com.projecthero.mod.symbiote.SymbioteAbilityManager.handle(
				player, com.projecthero.mod.hero.AbilitySlot.SLOT_3, true);
	...
	public void sonicDisruptionBlocksAbilities(GameTestHelper helper) {
		...
		com.projecthero.mod.combat.SonicVulnerability.expose(player, now, 100);
		helper.assertTrue(com.projecthero.mod.combat.SonicVulnerability.isDisrupted(player, now),
